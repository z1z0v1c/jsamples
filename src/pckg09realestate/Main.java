 ...
 *  - the price is calculated based on the square footage of X zone
 *  (I zone 3000, II zone 2000, III zone 1000, IV zone 500e).
 *  - the house has an additional area of the yard.
 *  - the price of the house includes the price of the yard, which is calculated according to the principle
 *  (yard area X Zone X 15%).
 *  - the apartment has two additional fields, the Basement area and the Terrace area.
 *  - the price of the apartment includes the price of the basement and terrace
 *  ((basement area + terrace area) X Zone X 33%).
 * <p>
 * Create the Main class and in it create instances of the Property class and create objects of derived classes
 * with arbitrary arguments. Print String representation of objects - toString().
 *
