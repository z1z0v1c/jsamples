...
* Create the Main class and in it create instances of the Geometry class and create objects of all base and derived classes with arbitrary arguments.
...
public class Main {
	...
	public static void main(String[] args) {
		...
		GeometricFigure inequilateralTriangle = new InequilateralTriangle("white", false, 4.5, 4.0, 3.5);
